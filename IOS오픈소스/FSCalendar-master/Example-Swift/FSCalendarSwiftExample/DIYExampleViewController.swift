...
//        calendar.clipsToBounds = true // Remove top/bottom line
        ...
        calendar.addGestureRecognizer(scopeGesture) //댕겨  올려짐 근데 올리면 먹통
        ...
        attributedText.append(NSAttributedString(attachment: attatchment))
        self.eventLabel.attributedText = attributedText  // 그 고양이 이벤트 배너임
    ...
    override func viewDidLoad() {
        ...
        let dates = [ // 오늘 날 기준으로 앞뒤로 3개 선택되는것
